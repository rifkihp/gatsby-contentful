            ...
            <ul className="flex items-center gap-4 mt-5">
              <li>
                <a
                  ...
                  href="http://twitter.com/RHeruprasetyo"
                  rel="me"
                >
                  <svg
              ...
              <li>
                <a
                  className="hover:text-teal-400"
                  href="http://github.com/rifki_rhp"
                  rel="me"
                >
                  <svg
                    className="w-8 h-auto"
              ...
              <li>
                <a
                  className="hover:text-teal-400"
                  href="https://www.instagram.com/kieize/"
                  rel="me"
                >
                  <svg
                    className="w-8 h-auto"
              ...
              <li>
                <a
                  className="hover:text-teal-400"
                  href="mailto:rifki_rhp@gmail.com"
                  rel="me"
                >
                  <svg
                    className="w-8 h-auto"
